...
```bash
cd projects/opencode-allowlist
bun install
```
...
```json
{
  "plugin": [
    ...
    "file:///Users/crayment/dev/copia/projects/opencode-allowlist/src/index.ts"
  ]
}
```
...
```json
{
  "allowedDirectories": ["/Users/crayment/dev/copia/projects"]
}
```
...
{
  "allowedDirectories": [
    "/Users/crayment/dev/copia/projects",
    "/Users/crayment/dev/other-workspace",
...
/Users/crayment/dev/copia/.opencode/opencode-allowlist.json                      ← Workspace level
/Users/crayment/dev/copia/projects/my-project/.opencode/opencode-allowlist.json  ← Project level
```
...
- ✅ `/Users/crayment/dev/copia/projects/project-a/file.ts`
- ✅ `/Users/crayment/dev/copia/projects/project-b/src/main.ts`
- ✅ `/Users/crayment/dev/copia/projects/nested/deep/file.md`

But these are NOT:

- ❌ `/Users/crayment/dev/copia/other-folder/file.ts`
- ❌ `/Users/crayment/dev/other-repo/file.ts`
